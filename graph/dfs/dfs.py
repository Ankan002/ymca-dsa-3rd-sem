"""
    ? Problem Statement: DFT Graph
    
    ! Time Complexity: O(v + e)
    ! Space Complexity: O(v)
"""

def dfs(edges: list[list[int]], graphType: str, startNode: int or None = None) -> None:
    """
